...
<b class="color>#fa8e8e mr>20px font-size>40px hvr:color>#8ed2fa cursor>none transition>0.5s"> Welcome! </b>  In the LIghtWindCSS <i class="color>#93fa8e font-size>20px hover:font-size>25px transition>0.5s cursor>pointer"> documentation </i> here you will be able to learn new things.`
        ...
        <div class="background>#422271 w>calc(100%_-_65px) border-radius>20px pl>25px pr>25px pt>5px pb>27px grid gap>20px grid-template-columns>1fr_1fr">
          ...
          <div>
            ...
            <div class="flex justify-content>center gap>25px pt>5px pb>5px">
              ...
              <div class="p>10px border>2px_dashed_#E98EEA border-radius>10px cursor>pointer">{topic}</div>
              {/each}
            </div>
          </div>
        </div>
